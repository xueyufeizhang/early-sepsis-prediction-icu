-- Source: MIT-LCP/mimic-code
-- mimic-iv/concepts/sepsis/suspicion_of_infection.sql (BigQuery dialect)
-- Reviewed against upstream main on 2026-08-30.
-- Public concept code only: query outputs remain protected patient-level data.
